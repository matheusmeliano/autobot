    ...
    return (
      <nav className="flex flex-col gap-5">
        {navGroups.map((group) => (
          <div
            key={group.label}
            className="rounded-2xl border border-[var(--app-border)] bg-[var(--app-card)] p-2 backdrop-blur-sm"
          >
                ...
                return (
                  <Link
                    ...
                    className={[
                      ...
                      active
                        ? "border-[var(--app-border)] bg-[var(--app-active)] text-[var(--app-text-85)] shadow-lg shadow-black/10"

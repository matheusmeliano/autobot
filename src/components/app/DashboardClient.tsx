...
function Card({
  ...
  return (
    <div className="rounded-2xl border border-[var(--app-border)] bg-[var(--app-solid-surface)] p-5 shadow-none">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <div className="text-xs font-semibold text-[var(--app-text-55)]">{title}</div>
          <div className="mt-2 truncate text-[1.7rem] font-bold tracking-tight">{value}</div>
          {subtitle ? (
            <div className="mt-1 text-xs text-[var(--app-text-45)]">{subtitle}</div>
          ) : null}
        </div>
        <div className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-[var(--app-card)] ring-1 ring-[var(--app-border)] text-[var(--app-accent-text)]">
          {icon}
        </div>
      </div>
    </div>
  ...
  return (
    <div>
      <motion.div
        ...
        className="flex flex-col justify-between gap-4 min-[1201px]:flex-row min-[1201px]:items-start"
      >
        ...
        <div className="hidden w-full flex-wrap items-center gap-2 min-[1201px]:flex min-[1201px]:justify-end">
          <div className="inline-flex w-full items-center gap-2 rounded-full border border-[var(--app-border)] bg-[var(--app-solid-surface)] px-4 py-2 text-xs font-semibold text-[var(--app-text-70)] min-[1201px]:w-auto shadow-none">
      ...
      <div className="mt-0 grid gap-4 min-[1201px]:mt-8 min-[1201px]:grid-cols-3">
        <Card
      ...
      <div className="mt-6 grid gap-4 min-[1201px]:grid-cols-5">
        <div className="flex h-full min-w-0 flex-col rounded-2xl border border-[var(--app-border)] bg-[var(--app-solid-surface)] p-5 shadow-none min-[1201px]:col-span-3">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div>
              <div className="text-base font-bold tracking-tight">Agendamentos criados</div>
          ...
          <div className="mt-4 min-h-[160px] flex-1">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={chart}>
                ...
                />
                <Area type="monotone" dataKey="value" stroke="#ea580c" strokeWidth={2.2} fill="url(#dashValue)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>

        <div className="flex h-full min-w-0 flex-col rounded-2xl border border-[var(--app-border)] bg-[var(--app-solid-surface)] p-5 shadow-none min-[1201px]:col-span-2">
          <div className="text-base font-bold tracking-tight">Atividades</div>
          <div className="mt-1 text-xs text-[var(--app-text-45)]">
            ...
            {activities.length ? (
              pagedActivities.map((item) => {
                ...
                return (
                  <div
                    key={item.id}
                    className="rounded-xl border border-[var(--app-border)] bg-[var(--app-solid-surface-2)] p-3"
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        <div className="truncate text-[15px] font-semibold text-[var(--app-text-85)]">{item.debtorName}</div>
              ...
              <div className="rounded-xl border border-[var(--app-border)] bg-[var(--app-solid-surface-2)] p-3">
                <div className="text-xs font-semibold text-[var(--app-text-85)]">Nenhum agendamento ainda</div>

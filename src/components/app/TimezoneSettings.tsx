    ...
    <div className="mt-6 rounded-2xl border border-[var(--app-border)] bg-[var(--app-card-2)] p-4">
      ...
      <div className="mt-4 flex flex-col gap-3 md:flex-row md:items-center">
        <select
          ...
          className="h-11 w-full rounded-xl border border-[var(--app-border)] bg-[var(--app-card)] px-4 text-sm text-[var(--app-text-85)] outline-none focus:border-[rgba(234,88,12,0.32)] focus:ring-0 [&>option]:bg-[var(--app-option-bg)] [&>option]:text-[var(--app-text-85)]"
        >

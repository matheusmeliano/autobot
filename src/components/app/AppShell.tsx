      ...
      <div className={drawerOnlyNav ? "min-h-0 lg:h-[100dvh] lg:overflow-hidden" : "min-h-[100dvh]"}>
        ...
        <div
          className={[
            ...
            drawerOnlyNav
              ? "pr-[80px] min-[1024px]:pr-[90px] h-[calc(100dvh-43px)] min-h-0 overflow-y-auto pb-0 min-[1201px]:h-[calc(100dvh-43px)] min-[1201px]:min-h-0 min-[1201px]:overflow-hidden lg:h-[calc(100dvh-43px)] lg:min-h-0 lg:overflow-hidden"

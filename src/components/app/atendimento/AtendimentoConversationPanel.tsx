...
export function AtendimentoConversationPanel({
  ...
  return (
    <div className="flex h-full min-h-[640px] flex-col rounded-2xl border border-[var(--app-border)] bg-[var(--app-card-2)]">
      <div className="border-b border-[var(--app-border)] px-4 py-4">
        ...
        <div className="mt-1 text-xs text-[var(--app-text-45)]">
          Histórico completo do lead dentro do módulo Atendimento.
        </div>
      </div>

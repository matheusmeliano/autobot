    ...
    <form onSubmit={onSubmit} className="space-y-3">
      <div>
        ...
        <div className="relative mt-2">
          <input
            ...
            className="w-full rounded-xl border border-[var(--app-border)] bg-[var(--app-card-2)] px-4 py-3 pr-11 text-sm text-[var(--app-text-85)] outline-none ring-0 placeholder:text-[var(--app-text-30)] focus:border-[rgba(234,88,12,0.32)] focus:ring-0"
          ...
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 rounded-lg p-1 text-[var(--app-text-65)] hover:text-[var(--app-text-85)] focus:outline-none focus:ring-0 transition-colors"
          >
      ...
      <div>
        ...
        <input
          type={showPassword ? "text" : "password"}
          autoComplete="new-password"
          className="mt-2 w-full rounded-xl border border-[var(--app-border)] bg-[var(--app-card-2)] px-4 py-3 text-sm text-[var(--app-text-85)] outline-none ring-0 placeholder:text-[var(--app-text-30)] focus:border-[rgba(234,88,12,0.32)] focus:ring-0"

        ...
        <div>
          ...
          <div className="relative mt-2">
            ...
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 rounded-lg p-1 text-white/60 hover:text-white focus:outline-none focus:ring-2 focus:ring-white/15 transition-colors"
            >

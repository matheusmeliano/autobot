...
export default function CadastroRecorrenteBody() {
  ...
  const [alunoForcePainel, setAlunoForcePainel] = useState(false);
  ...
  if ((alunoIsMatriculaConcluida || alunoForcePainel) && !initialDataLoading) {
    ...
    <main className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-sky-50 py-10 px-4 sm:px-6">
      <div className="mx-auto max-w-3xl w-full">
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-indigo-100/50 border border-slate-100 p-6 sm:p-10">
          ...
          {step === 0 && (
            <>
              <div className="w-full rounded-2xl border border-indigo-500/25 bg-indigo-500/10 px-4 py-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-left text-sm text-slate-700 leading-relaxed">
                    Caso tenha qualquer dúvida sobre o funcionamento das aulas contratadas,
                    formas de pagamento ou qualquer outra questão, entre em contato com nosso
                    suporte pelo número{" "}
                    <a
                      href="https://wa.me/5565999495594"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="font-semibold text-indigo-700 underline decoration-indigo-500/40 underline-offset-2 hover:decoration-indigo-600/80"
                    >
                      (65) 9 9949-5594
                    </a>
                    .
                    ...
                    >
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
                        ...
                        <div className="sm:text-right sm:shrink-0 self-start sm:self-center">
                          <div className="text-2xl sm:text-3xl font-black text-slate-900 leading-none">US$ 99,00</div>
                ...
                <>
                  ...
                  <div>
                    ...
                    <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-slate-300 bg-slate-50 px-5 py-2">
                      ...
                      <div className="text-2xl sm:text-3xl font-black text-slate-900">US$ 99,00</div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 max-w-2xl mx-auto w-full">
                    ...
                    <div className="rounded-3xl border-2 border-emerald-200 bg-white p-5 sm:p-6 flex flex-col shadow-sm">
                      ...
                      <div className="w-full rounded-2xl bg-slate-50 border border-slate-200 p-3 sm:p-4 break-all font-mono text-[11px] sm:text-xs leading-relaxed text-slate-800 select-all">
                        00020126360014br.gov.bcb.pix0114+55659998511425204000053039865406495.005802BR5920Loivo de Brum Castro6009SAO PAULO62070503***6304E2C4
                      </div>
                      <button
                        onClick={async () => {
                          try {
                            const code = "00020126360014br.gov.bcb.pix0114+55659998511425204000053039865406495.005802BR5920Loivo de Brum Castro6009SAO PAULO62070503***6304E2C4";
            ...
            <section className="space-y-7 text-center">
              ...
              <div>
                ...
                <p className="mt-5 text-lg text-slate-600 leading-relaxed max-w-2xl mx-auto">
                  Você receberá uma notificação pelo WhatsApp em até 24 horas, assim que o pagamento for confirmado. Até lá, sua matrícula permanecerá como pré-aprovada. Nessa mesma notificação, enviaremos o link de <strong>acesso ao seu painel</strong>, onde você poderá <strong>consultar o número da matrícula</strong>, <strong>editar o dia e horário das aulas</strong> e <strong>acessar o contrato simplificado</strong> confirmado durante o processo de matrícula.
                </p>
              </div>
